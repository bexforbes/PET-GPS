 ...
 */
  ...
  // PET dimensions
  G4double PET_in_rad = 35*cm, PET_out_rad = PET_in_rad + CrystLength*cm, PET_length = DetLength*m; // vary these
...
new G4PVPlacement(0,                       // no rotation
  ...
  // patient
  //
  G4double patient_radius = 18*cm;
  G4double patient_dZ = 160*cm;  
